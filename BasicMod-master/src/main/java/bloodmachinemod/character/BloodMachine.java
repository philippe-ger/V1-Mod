package bloodmachinemod.character;
...
import static bloodmachinemod.BloodMachineMod.characterPath;
import static bloodmachinemod.BloodMachineMod.makeID;

public class BloodMachine extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("BloodMachine"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass BLOOD_MACHINE;
        @SpireEnum(name = "V1_BLUE_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "V1_BLUE_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public BloodMachine() {
        super(NAMES[0], Enums.BLOOD_MACHINE,
        ...
        initializeClass(characterPath("V1.png"),
                SHOULDER_2,
                SHOULDER_1,
                CORPSE,
                getLoadout(),
    ...
    public void doCharSelectScreenSelectEffect() {
        ...
        CardCrawlGame.sound.playA(makeID("SFX_SELECT"), 0F);
