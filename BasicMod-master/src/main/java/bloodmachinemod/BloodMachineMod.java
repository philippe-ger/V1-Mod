...
public class BloodMachineMod implements
    ...
    private static final String resourcesFolder = "bloodmachinemod";
    ...
    private static final Color cardColor = new Color(15f/255f, 31f/255f, 82f/255f, 1f);
    ...
    public static void initialize() {
        ...
        BaseMod.addColor(BloodMachine.Enums.CARD_COLOR, cardColor,
                BG_ATTACK, BG_SKILL, BG_POWER, ENERGY_ORB,
                BG_ATTACK_P, BG_SKILL_P, BG_POWER_P, ENERGY_ORB_P,
                SMALL_ORB);
    }

    public BloodMachineMod() {
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(BloodMachineMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new BloodMachine(),
                CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT, BloodMachine.Enums.BLOOD_MACHINE);
    }
    @Override
